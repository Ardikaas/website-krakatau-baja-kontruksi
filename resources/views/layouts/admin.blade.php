...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/owl.js', 'resources/css/landingPageSection7.css', 'resources/js/landingPageSection7.js'])    @stack('styles')
</head>
