...
@section('content')
    {{-- Banner Top Section --}}
    <x-landingPageSection1 type="page" title="Company Governance" :breadcrumb="[['label' => 'Home', 'url' => url('/')], ['label' => 'Company Governance']]" imagePath="images/background/page-title.jpg" />
