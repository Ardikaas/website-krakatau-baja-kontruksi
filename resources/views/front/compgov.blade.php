...
@section('content')
    {{-- Banner Top Section --}}
    <x-landingPageSection1 type="page" title="{{ __('messages.page_company_governance') }}" :breadcrumb="[['label' => 'Home', 'url' => url('/')], ['label' => __('messages.page_company_governance')]]" imagePath="images/background/page-title.jpg" />

    {{-- Large Image Section --}}
    <section class="image-section" style="padding: 50px 0 0 0;">
        <div class="auto-container">
            <div class="image-box" style="text-align: center;">
                <img src="{{ asset('images/background/visi-misi-about-us.png') }}" alt="Company Governance" style="width: 100%; max-width: 100%;">
            </div>
        </div>
    </section>
