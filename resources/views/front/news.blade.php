                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="link-box"><a href="{{ route('news.detail', 1) }}"><i
                                            class="flaticon-right-arrow"></i><span>Read the Post</span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="link-box"><a href="{{ route('news.detail', 2) }}"><i
                                            class="flaticon-right-arrow"></i><span>Read the Post</span></a></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="inner-box">
                            <div class="upper-content z_1">
                                <div class="info-box">
                                    ...
                                    <div class="author-box">
                                        <figure class="author-image"><img src="{{ asset('images/news/author-3.png') }}"
                                                alt=""></figure>
                                        <div class="inner">
                                            <h5>E.Fransis</h5>
                                ...
                                <div class="image-box">
                                    <figure class="image"><a href="{{ route('news.detail', 3) }}"><img
                                                src="{{ asset('images/news/news-8.jpg') }}" alt=""></a></figure>
                                    <span class="category">Quality Control</span>
                                    <div class="zoom-btn"><a href="{{ asset('images/news/news-8.jpg') }}"
                                            class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zoom"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="lower-content">
                                <h3><a href="{{ route('news.detail', 3) }}">How to Choose the Right Metal for Your Unique
                                        Project Needs.</a></h3>
                                <div class="link-box"><a href="{{ route('news.detail', 3) }}"><i
                                            class="flaticon-right-arrow"></i><span>Read the Post</span></a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            <div class="upper-content z_1">
                                ...
                                <div class="image-box">
                                    <figure class="image"><a href="{{ route('news.detail', 4) }}"><img
                                                src="{{ asset('images/news/news-9.jpg') }}" alt=""></a></figure>
                                    <span class="category">Technical Guides</span>
                                    <div class="zoom-btn"><a href="{{ asset('images/news/news-9.jpg') }}"
                                            class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zoom"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="lower-content">
                                <h3><a href="{{ route('news.detail', 4) }}">Metal Finishing Techniques: An In-Depth
                                        Practical Guide.</a></h3>
                                <div class="link-box"><a href="{{ route('news.detail', 4) }}"><i
                                            class="flaticon-right-arrow"></i><span>Read the Post</span></a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            <div class="upper-content z_1">
                                ...
                                <div class="image-box">
                                    <figure class="image"><a href="{{ route('news.detail', 5) }}"><img
                                                src="{{ asset('images/news/news-10.jpg') }}" alt=""></a></figure>
                                    <span class="category">Industry Trends</span>
                                    <div class="zoom-btn"><a href="{{ asset('images/news/news-10.jpg') }}"
                                            class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zoom"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="lower-content">
                                <h3><a href="{{ route('news.detail', 5) }}">The Difference Between Forging &amp; Casting
                                        in Metal Manufacturing.</a></h3>
                                <div class="link-box"><a href="{{ route('news.detail', 5) }}"><i
                                            class="flaticon-right-arrow"></i><span>Read the Post</span></a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            <div class="upper-content z_1">
                                ...
                                <div class="image-box">
                                    <figure class="image"><a href="{{ route('news.detail', 6) }}"><img
                                                src="{{ asset('images/news/news-11.jpg') }}" alt=""></a></figure>
                                    <span class="category">Quality Control</span>
                                    <div class="zoom-btn"><a href="{{ asset('images/news/news-11.jpg') }}"
                                            class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zoom"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="lower-content">
                                <h3><a href="{{ route('news.detail', 6) }}">How to Choose the Right Metal for Your Unique
                                        Project Needs.</a></h3>
                                <div class="link-box"><a href="{{ route('news.detail', 6) }}"><i
                                            class="flaticon-right-arrow"></i><span>Read the Post</span></a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            <div class="upper-content z_1">
                                ...
                                <div class="image-box">
                                    <figure class="image"><a href="{{ route('news.detail', 7) }}"><img
                                                src="{{ asset('images/news/news-12.jpg') }}" alt=""></a></figure>
                                    <span class="category">Maintenance</span>
                                    <div class="zoom-btn"><a href="{{ asset('images/news/news-12.jpg') }}"
                                            class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zoom"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="lower-content">
                                ...
                                <div class="link-box"><a href="{{ route('news.detail', 7) }}"><i
                                            class="flaticon-right-arrow"></i><span>Read the Post</span></a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            <div class="upper-content z_1">
                                ...
                                <div class="image-box">
                                    <figure class="image"><a href="{{ route('news.detail', 8) }}"><img
                                                src="{{ asset('images/news/news-13.jpg') }}" alt=""></a></figure>
                                    <span class="category">Company News</span>
                                    <div class="zoom-btn"><a href="{{ asset('images/news/news-13.jpg') }}"
                                            class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zoom"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="lower-content">
                                ...
                                <div class="link-box"><a href="{{ route('news.detail', 8) }}"><i
                                            class="flaticon-right-arrow"></i><span>Read the Post</span></a></div>
                            </div>
                        </div>
                    </div>
