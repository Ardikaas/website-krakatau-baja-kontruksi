...
@section('content')
    {{-- Banner --}}
    <x-landingPageSection1 type="page" title="Project" 
        :breadcrumb="[['label' => 'Home', 'url' => url('/')], ['label' => 'Project']]" 
                                ...
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image">
                                            ...
                                            <img src="{{ $project->image ? asset('storage/'.$project->image) : asset('images/default_project.png') }}" alt="{{ $project->title }}">
                                        </figure>
                                        <div class="icon-box">
                                            <i class="{{ $project->icon ?? 'flaticon-turning' }}"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content-box">
                                        ...
                                        <div class="overlay-content">
                                            ...
                                            <div class="btn-box">
                                                <a href="{{ route('front.projects.show', $project) }}" class="theme-btn btn-one">
                                                    <i class="flaticon-right-arrow"></i>
                                                    <span>Read More</span>
                                                </a>
                                            </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                    <div class="sidebar-content">
                        <div class="inner-box centred">
                            ...
                            <a href="{{ url('/contact') }}" class="theme-btn"><i class="flaticon-right-arrow"></i><span>Appointment</span></a>
                        </div>
                    </div>
                </div>
            </div>
